/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 66a03a6fa3761d87a192c1cb97d53fae)
// Runtime types generated with workerd@1.20260815.1 2026-08-18 nodejs_compat
interface __BaseEnv_Env {
	ACCOUNT_DB: D1Database;
	ENVIRONMENT: "production" | "development";
	EMAIL_DELIVERY_MODE: "live" | "test";
	RESEND_FROM: "Fuddy <login@fuddy.ai>" | "Fuddy <onboarding@resend.dev>";
	GOOGLE_CLIENT_IDS: "877382581311-dt2ln9r81lqe8i0d6svknfs1dfi1s889.apps.googleusercontent.com,877382581311-i6dn0r7k47ij545p7cddpa33t01oe1jd.apps.googleusercontent.com" | "";
	OTP_PEPPER: string;
	SESSION_TOKEN_PEPPER: string;
	RESEND_API_KEY: string;
	RESEND_WEBHOOK_SECRET: string;
	GOOGLE_CLIENT_SECRET: string;
	RELAY_ADMIN?: Service /* entrypoint RelayAdministration from project-agent-companion-relay */;
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		RESEND_FROM: "Fuddy <login@fuddy.ai>";
		GOOGLE_CLIENT_IDS: "877382581311-dt2ln9r81lqe8i0d6svknfs1dfi1s889.apps.googleusercontent.com,877382581311-i6dn0r7k47ij545p7cddpa33t01oe1jd.apps.googleusercontent.com";
		OTP_PEPPER: string;
		SESSION_TOKEN_PEPPER: string;
		RESEND_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EMAIL_DELIVERY_MODE" | "RESEND_FROM" | "GOOGLE_CLIENT_IDS" | "OTP_PEPPER" | "SESSION_TOKEN_PEPPER" | "RESEND_API_KEY" | "RESEND_WEBHOOK_SECRET" | "GOOGLE_CLIENT_SECRET">> {}
}
