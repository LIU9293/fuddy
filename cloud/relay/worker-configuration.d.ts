/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cdb4040a35c149496068997e35984378)
// Runtime types generated with workerd@1.20260801.1 2026-08-07 nodejs_compat
interface __BaseEnv_Env {
	ATTACHMENTS: R2Bucket;
	PAIRING_RATE_LIMIT: RateLimit;
	PAIRING_CLAIM_RATE_LIMIT: RateLimit;
	APNS_TEAM_ID: "5PR3342M58";
	APNS_KEY_ID: "N768DXSCY3";
	APNS_TOPIC: "dev.ainative.projectagent.companion";
	APNS_ENVIRONMENT: "production";
	APNS_PRIVATE_KEY: string;
	ACCOUNT_RELAY: DurableObjectNamespace<import("./src/index").AccountRelay>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AccountRelay";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APNS_TEAM_ID" | "APNS_KEY_ID" | "APNS_TOPIC" | "APNS_ENVIRONMENT" | "APNS_PRIVATE_KEY">> {}
}
